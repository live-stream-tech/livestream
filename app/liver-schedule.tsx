...
const styles = StyleSheet.create({
  ...
  infoBanner: {
    ...
    marginHorizontal: 16, marginBottom: 12, borderRadius: 0, padding: 12,
  ...
  dayPill: {
    ...
    borderRadius: 0, backgroundColor: C.surface, borderWidth: 1, borderColor: C.border,
  },
  ...
  dayDot: { width: 5, height: 5, borderRadius: 0, backgroundColor: C.accent, marginTop: 3 },
  scroll: { flex: 1 },
  dateLabel: {
  ...
  emptyAddBtn: {
    ...
    backgroundColor: C.accent, borderRadius: 0, paddingHorizontal: 16, paddingVertical: 8,
  },
  emptyAddBtnText: { fontSize: 14, fontWeight: "600", color: "#fff" },
  slotCard: {
    backgroundColor: C.surface, marginHorizontal: 16, marginBottom: 10,
    borderRadius: 0, padding: 14, borderWidth: 1, borderColor: C.border,
  },
  ...
  fillBarBg: { height: 4, backgroundColor: C.surface2, borderRadius: 0, overflow: "hidden" },
  fillBarFill: { height: "100%", borderRadius: 0 },
  ...
  saveBtn: {
    ...
    backgroundColor: C.accent, borderRadius: 0, paddingVertical: 14,
  },
