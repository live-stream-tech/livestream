...
const styles = StyleSheet.create({
  ...
  adThumb: { width: 80, height: 54, borderRadius: 0 },
  adBody: { flex: 1, gap: 4 },
  adTitle: { color: "#fff", fontSize: 13, fontWeight: "700" },
  adSub: { color: "rgba(255,255,255,0.55)", fontSize: 11 },
  adCtaBtn: { paddingHorizontal: 10, paddingVertical: 7, borderRadius: 0 },
  ...
  staffAvatar: { width: 28, height: 28, borderRadius: 0, backgroundColor: C.surface3 },
  ...
  staffPickerAvatar: { width: 36, height: 36, borderRadius: 0, backgroundColor: C.surface3 },
  staffPickerName: { flex: 1, color: C.text, fontSize: 14, fontWeight: "600" },
  cancelBtn: { paddingVertical: 12, paddingHorizontal: 16, borderRadius: 0, backgroundColor: C.surface3 },
  ...
  threadDetailAvatar: { width: 28, height: 28, borderRadius: 0 },
  ...
  threadPostAvatar: { width: 32, height: 32, borderRadius: 0 },
