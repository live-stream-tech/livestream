...
const styles = StyleSheet.create({
  ...
  queueItemAvatar: { width: 12, height: 12, borderRadius: 0 },
  ...
  chatAvatar: { width: 24, height: 24, borderRadius: 0, flexShrink: 0 },
  chatBubble: {
  ...
  modalThumb: { width: 64, height: 40, borderRadius: 0 },
  ...
  ytPlaylistChipThumb: { width: "100%", height: 56, borderRadius: 0 },
  ytPlaylistChipTitle: {
    color: C.text,
    fontSize: 11,
    padding: 6,
