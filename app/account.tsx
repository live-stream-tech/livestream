...
const styles = StyleSheet.create({
  ...
  enneagramDot: { width: 8, height: 8, borderRadius: 0 },
  ...
  pinnedThumb: { width: 48, height: 36, borderRadius: 0 },
  ...
  pinnedCheckEmpty: { width: 22, height: 22, borderRadius: 0, borderWidth: 2, borderColor: C.border },
});
