...
const styles = StyleSheet.create({
  ...
  filterItem: {
    ...
    backgroundColor: C.surface, borderRadius: 0, paddingHorizontal: 10, paddingVertical: 8,
    borderWidth: 1, borderColor: C.border,
  },
  ...
  avatar: { width: 64, height: 64, borderRadius: 0 },
  cardInfo: { flex: 1 },
  nameRow: { flexDirection: "row", alignItems: "center", gap: 8, marginBottom: 2 },
  name: { fontSize: 16, fontWeight: "700", color: C.text },
  rankBadge: {
    backgroundColor: C.surface3, borderRadius: 0, paddingHorizontal: 6, paddingVertical: 2,
  },
  ...
  scoreBadge: {
    flex: 1, alignItems: "center", paddingVertical: 8, borderRadius: 0,
    borderWidth: 1,
  },
