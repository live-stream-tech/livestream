...
const styles = StyleSheet.create({
  ...
  profileCard: {
    ...
    backgroundColor: C.surface, borderRadius: 0, padding: 14,
    borderWidth: 1, borderColor: C.border,
  },
  avatar: { width: 80, height: 80, borderRadius: 0 },
  profileInfo: { flex: 1 },
  nameRankRow: { flexDirection: "row", alignItems: "center", gap: 8, marginBottom: 2 },
  name: { fontSize: 18, fontWeight: "800", color: C.text },
  rankBadge: {
    flexDirection: "row", alignItems: "center", gap: 4,
    backgroundColor: C.surface3, borderRadius: 0, paddingHorizontal: 7, paddingVertical: 3,
  },
  ...
  tabs: {
    ...
    backgroundColor: C.surface, borderRadius: 0, padding: 4,
    borderWidth: 1, borderColor: C.border,
  },
  tab: { flex: 1, paddingVertical: 8, borderRadius: 0, alignItems: "center" },
  ...
  scoreCard: {
    backgroundColor: C.surface, borderRadius: 0, padding: 16,
  ...
  scoreBarBg: { flex: 1, height: 8, backgroundColor: C.surface2, borderRadius: 0, overflow: "hidden" },
  scoreBarFill: { height: "100%", borderRadius: 0 },
  scoreBarValue: { fontSize: 13, fontWeight: "700", width: 30, textAlign: "right" },
  metricsGrid: { flexDirection: "row", gap: 8, marginBottom: 16 },
  metricCard: {
    flex: 1, backgroundColor: C.surface, borderRadius: 0, padding: 14,
  ...
  bookBtn: {
    ...
    backgroundColor: C.accent, borderRadius: 0, paddingVertical: 13, marginBottom: 8,
  },
  ...
  addReviewBtn: {
    flexDirection: "row", alignItems: "center", gap: 4,
    backgroundColor: C.surface, borderRadius: 0, paddingHorizontal: 12, paddingVertical: 6,
  ...
  firstReviewBtn: {
    paddingHorizontal: 16, paddingVertical: 8, borderRadius: 0, backgroundColor: C.accent,
  },
  ...
  reviewerAvatar: { width: 36, height: 36, borderRadius: 0 },
  ...
  reviewOverallBadge: {
    ...
    backgroundColor: "#2A1F00", borderRadius: 0, paddingHorizontal: 8, paddingVertical: 4,
  },
  ...
  slotStatusBadge: {
    backgroundColor: "#0D2330", borderRadius: 0, paddingHorizontal: 8, paddingVertical: 4,
  },
  slotStatusFull: { backgroundColor: "#2A0F0F" },
  slotStatusText: { fontSize: 11, fontWeight: "600", color: C.accent },
  slotBookBtn: {
    backgroundColor: C.accent, borderRadius: 0, paddingHorizontal: 14, paddingVertical: 6,
  },
  slotBookBtnText: { fontSize: 12, fontWeight: "700", color: "#fff" },
  modalOverlay: { flex: 1, backgroundColor: "rgba(0,0,0,0.6)", justifyContent: "flex-end" },
  modalSheet: {
    backgroundColor: C.surface, borderTopLeftRadius: 0, borderTopRightRadius: 0, padding: 20,
  },
  modalHandle: { width: 36, height: 4, backgroundColor: C.border, borderRadius: 0, alignSelf: "center", marginBottom: 16 },
  ...
  modalInput: {
    backgroundColor: C.surface2, borderRadius: 0, paddingHorizontal: 12, paddingVertical: 10,
  ...
  submitBtn: {
    flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8,
    backgroundColor: C.accent, borderRadius: 0, paddingVertical: 14, marginTop: 4,
  },
