...
const styles = StyleSheet.create({
  ...
  avatar: { width: 66, height: 66, borderRadius: 0 },
  profileInfo: { gap: 6 },
  ...
  legendDot: { width: 6, height: 6, borderRadius: 0 },
  ...
  legendBarFill: { height: "100%", borderRadius: 0 },
  ...
  activeBadge: { backgroundColor: C.accent, borderRadius: 0, paddingHorizontal: 6, paddingVertical: 2 },
  ...
  progressFill: { height: "100%", backgroundColor: C.accent, borderRadius: 0 },
  ...
  timelineThumb: { width: 40, height: 40, borderRadius: 0, backgroundColor: C.surface2 },
  timelineBody: { flex: 1 },
  ...
  previewAvatar: { width: 80, height: 80, borderRadius: 0 },
