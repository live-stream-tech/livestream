...
const styles = StyleSheet.create({
  ...
  liveDot: { width: 6, height: 6, borderRadius: 0, backgroundColor: "#fff" },
  ...
  creatorAvatar: { width: 36, height: 36, borderRadius: 0, borderWidth: 2, borderColor: "rgba(255,255,255,0.4)" },
  ...
  chatAvatar: { width: 24, height: 24, borderRadius: 0 },
  chatBubble: {
  ...
  giftModalHandle: { width: 36, height: 4, borderRadius: 0, backgroundColor: C.border, alignSelf: "center", marginBottom: 16 },
