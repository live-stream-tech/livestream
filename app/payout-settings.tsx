...
const styles = StyleSheet.create({
  ...
  securityBadge: {
    ...
    backgroundColor: "#0F2E1A", borderRadius: 0, paddingHorizontal: 10, paddingVertical: 4,
  },
  securityBadgeText: { fontSize: 11, color: C.green, fontWeight: "600" },
  saveBtn: {
    flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8,
    backgroundColor: C.accent, marginHorizontal: 16, borderRadius: 0, paddingVertical: 14,
    marginBottom: 12,
  },
