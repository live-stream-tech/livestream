...
const TERMS = [
  ...
  },
  {
    ...
    title: "SNS投稿制限",
    body: "メンターセッション内容・クリエイターの発言・映像等のSNS投稿・拡散を禁止します。",
  },
  {
    id: "no_contact",
...
export default function TwoshotBookingScreen() {
  ...
  async function handleProceedToPayment() {
    if (!allAgreed) return;
    if (!requireAuth("メンターセッション")) return;
    setLoading(true);
    try {
  ...
  return (
    <View style={[styles.container, { paddingBottom: bottomInset }]}>
      ...
      <View style={[styles.header, { paddingTop: topInset + 12 }]}>
        ...
        <Text style={styles.headerTitle}>メンターセッション</Text>
        <View style={{ width: 40 }} />
      </View>
          ...
          <View style={styles.section}>
            ...
            <View style={styles.confirmCard}>
              ...
              <View style={styles.confirmRow}>
                ...
                <Text style={styles.confirmValue}>メンターセッション</Text>
              </View>
              <View style={styles.confirmRow}>
            ...
            <View style={styles.warningBox}>
              ...
              <Text style={styles.warningText}>
                ウォーターマーク（透かし）がメンターセッション中の画面に表示されます。無断キャプチャ・転載は規約違反となります。
              </Text>
            </View>
