    ...
    <div class="vision-wrap">
      <div class="vision-inner">
        ...
        <p class="v-body">
          ...
          日本のインディーズが、ベルリンの夜に、ソウルの路地に、ニューヨークの部屋に響く未来。<br>
          言葉はAIが繋ぐ。<br>
          でも震えとか、叫びとか、胸が熱くなる瞬間は――絶対に機械じゃ再現できない。<br>
          RawStockはそれを、そのまま届ける場所。
        </p>

        <div class="v-divider"></div>

        <p class="v-close">今はちっちゃいけど、最初から世界を狙ってる。一緒にこのシーンをデカくしていきませんか？</p>
